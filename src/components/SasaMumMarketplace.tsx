...
interface SasaMumMarketplaceProps {
  onBack: () => void;
  userName?: string;
}
...
export function SasaMumMarketplace({ onBack, userName = "Brenda" }: SasaMumMarketplaceProps) {
  useScrollToTop();
            ...
            <Card className="border-primary/20 bg-primary/5">
              <CardHeader className="pb-3">
                <h4 className="text-foreground flex items-center space-x-2">
                  ...
                  <span>SasaMum Support Fund</span>
                </h4>
                <p className="text-sm text-muted-foreground">
              ...
              <Card className="border-border">
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      "Thanks to the SasaMum fund, I was able to get emergency formula for my baby 
